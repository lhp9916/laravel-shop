                            ...
                            @if($product->type === \App\Models\Product::TYPE_CROWDFUNDING)
                                <div class="crowdfunding-info">
                                    ...
                                    <div class="progress-info">
                                        <span class="current-progress">当前进度：{{ $product->crowdfunding->percent }}
                                            %</span>
                                        <span class="pull-right user-count">{{ $product->crowdfunding->user_count }}
                                            名支持者</span>
                                    </div>
                                    <!-- 如果众筹状态是众筹中，则输出提示语 -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-crowdfunding').click(function () {
                ...
                var addresses = {!! json_encode(Auth::check() ? Auth::user()->address : []) !!};
                // 使用 jQuery 动态创建一个表单
