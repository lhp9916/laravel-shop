    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h4>分期付款详情</h4></div>
                        ...
                        <div class="installment-info">
                            <div class="line">
                                ...
                                <div class="line-value">
                                    <a href="{{ route('orders.show',['order'=>$installment->order_id]) }}"
                                       target="_blank">查看</a>
                                </div>
                            </div>
                            <div class="line">
                        ...
                        <div class="installment-next text-right">
                            ...
                            @else
                                ...
                                <div class="payment-buttons">
                                    <a href="{{ route('installments.alipay',['installment'=>$installment->id]) }}"
    ...
    <script>
        $(document).ready(function () {
            $('#btn-wechat').click(function () {
                swal({
                    content: $('<img src="{{ route('installment.wechat',['installment'=>$installment->id]) }}" />')[0],
                    buttons: ['关闭', '已完成付款']
